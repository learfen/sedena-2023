...
module.exports = function (app) { 
    ...
    app.get("/refam/api/album/explorer", (req , res)=>{ 
        try {
    ...
    app.get("/refam/api/album/explorer/:id", (req , res)=>{ 
        try {
            controller.navegate(req , res)
        } catch (error) {
            log.write( req.originalUrl ,  error )
    ...
    app.put("/refam/api/album/explorer/:id", (req , res)=>{ 
        try {
    ...
    app.delete("/refam/api/album/explorer/:id", (req , res)=>{ 
        try {
    ...
    app.put("/refam/api/album/explorer-media/:id", (req , res)=>{ 
        try {
            controller.pushMedia(req , res)
        } catch (error) {
            log.write( req.originalUrl ,  error )
        }
    })

    app.delete("/refam/api/album/explorer-media/:id", (req , res)=>{ 
        try {
            controller.pushMedia(req , res)
        } catch (error) {
            log.write( req.originalUrl ,  error )
