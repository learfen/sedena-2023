...
exports.createSupportIssue = (req, res, next) => {
    ...
    SupportRequest.create({
        ...
        db.user.findOne({where:{email:supportIssue.clientUserMail}}).then ( user => {
            supportIssue.userEnrollment = user !== null  ? user.dataValues.enrollment : 'Email no relacionado a ningun usuario'
            ...
            emailSupportBodyProblem.userEnrollment = supportIssue.userEnrollment
            ...
            if (fileImagePath !== "") {
                let fileImageCompletePath = "https://refam.sedena.gob.mx/refam/tmp_support/" + fileImagePath
