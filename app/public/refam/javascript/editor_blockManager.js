let blocks = [{
		id: "base-template-1", // id is mandatory
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete18.png);min-height:160px">
				<div class="my-label-block">Template 1</div>
				</div>`, // Set the images here
		category: "Templates",
		attributes: { class: "gjs-block-section" , style:"height:180px"},
		content: `
		<link rel="stylesheet" href="/refam/css/fontsCustom.css">
		<link rel="stylesheet" href="/refam/css/style.css">
			<div class="template v-18">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete3.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete2.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete22.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete1.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete24.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete13.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete27.png);min-height:160px">
		...
		<link rel="stylesheet" href="/refam/css/fontsCustom.css">
		<link rel="stylesheet" href="/refam/css/style.css">
			<div class="template v-19 bg-gray">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete15.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete5.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete4.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete17.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete19.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete11.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete20.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete26.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete12.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete25.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete21.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete14.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete16.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete6.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete23.png);min-height:160px">
	...
	, {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete10.png);min-height:160px">
	...
	${model.get("label")}
		...
		id: "base-template-25", // id is mandatory
		label:`<div style="background-image:url(/refam/images/letter-capital.png)">
			<div class="my-label-block">Letra capital</div>
			</div>`,
		category: "Personalizados",
		attributes: { class: "gjs-block-section" , style:"height:90px"},
		content: `
		<link rel="stylesheet" href="/refam/css/fontsCustom.css">
		<link rel="stylesheet" href="/refam/css/style.css">
			<div class="text-content letter-capital">
			<p><c style="font-size:65px">C</c><span>on estas acciones, ambas dependencias  del pueblo de México.we Although nosotros and nosotras are given as translations of we, in practice they are used only for emphasis: we went to the theater fuimos al teatro; we did it ...</span></p>
			</div>`,
		render: ({ model, className }) => `<div class="${className}__my-wrap">
	${model.get("label")}
	</div>`,
		...
		id: 'imgNavegation',
		label:`<div style="background-image:url(/refam/images/imgNavegation.png)">
			<div class="my-label-block">[ Imagen ]</div>
			</div>`,
		category: 'Personalizados',
		select: true,
		attributes: { class: "gjs-block-section" , style:"height:90px"},
		...
		<link rel="stylesheet" href="/refam/css/fontsCustom.css">
		<link rel="stylesheet" href="/refam/css/style.css">
			<div style="width:100vw;height:100vh;overflow:scroll" class="navegation"></div>`,
		activate: true
	},{
		id: 'imgCenter',
		label:`<div style="background-image:url(/refam/images/imgNavegation.png)">
			<div class="my-label-block">Centrado</div>
			</div>`,
		category: 'Personalizados',
		select: true,
		attributes: { class: "gjs-block-section" , style:"height:90px"},
		...
		<link rel="stylesheet" href="/refam/css/fontsCustom.css">
		<link rel="stylesheet" href="/refam/css/style.css">
			<div style="width:100%;padding: 20px 5%;display:flex;justify-content:center;align-items:center;flex-direction:column"></div>`,
		activate: true
	},{
		id: 'listN',
		label:`<div style="background-image:url(/refam/images/list-tag.png)">
			<div class="my-label-block">Listar</div>
			</div>`,
		category: 'Personalizados',
		select: true,
		attributes: { class: "gjs-block-section" , style:"height:90px"},
		...
		<link rel="stylesheet" href="/refam/css/fontsCustom.css">
		<link rel="stylesheet" href="/refam/css/style.css">
			<ul style="font-size:20px;line-height:25px">
				<li>Item 1</li>
				<li>Item 2</li>
				<li>Item 3</li>
			</ul>`,
		...
		category: 'Personalizados',
		select: true,
		label:`<div style="background-image:url(/refam/images/video.png)">
			<div class="my-label-block">Video</div>
			</div>`,
		attributes: { class: "gjs-block-section gjs-f-video" , style:"height:90px"},
		content: {type: 'video',style:"background-color:#aaa000"},
		activate: true
	}, {
		id: 'text',
		label: 'Parrafo',
		...
		content: `
		<link rel="stylesheet" href="/refam/css/fontsCustom.css">
		<link rel="stylesheet" href="/refam/css/style.css"><p style="font-size:20px;line-height:25px;">Con estas acciones, ambas dependencias refrendan su compromiso</p>`,
	}, {
		id: 'textEnd',
		label: `<div style="background-image:url(/refam/images/textEnd.png)">
		<div class="my-label-block">Marca final</div>
		</div>`,
		category: 'Personalizados',
		content: `<span class="textEnd" style="margin: 0px .5rem !important;margin-bottom: -10px !important;display:inline-blocK">
			<i style="display:inline-blocK;min-width:1.8rem;min-height:1.5rem;-webkit-mask-size:cover;-webkit-mask-image: url(/refam/images/textEndDark.svg);background:#333333"></i>
		</span>`,
	}, {
		id: 'heading',
		label:`<div style="background-image:url(/refam/images/encabezado.png)">
			<div class="my-label-block">Encabezado</div>
			</div>`,
		attributes: { class: "gjs-block-section" , style:"height:90px"},
		category: 'Personalizados',
		content: `
...
function base_magazine() {
		...
		label:`<div style="background-size: 100%;background-repeat: no-repeat;background-position-y:20px;background-position-x: center;background-image:url(/refam/templates/templete18.png);min-height:60px">
				<div class="my-label-block">Template 1</div>
				</div>`, // Set the images here
		category: "Templates",
		attributes: { class: "gjs-block-section" , style:"height:180px"},
...
function editor_blockManager( editor ){
